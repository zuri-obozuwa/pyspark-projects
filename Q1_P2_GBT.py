...
gbt = GBTClassifier(labelCol="label", featuresCol="features", maxBins = 16, maxDepth = 7, maxIter = 15)
...
pred = gbtModel.transform(testData)
...
featI = gbtModel.featureImportances
